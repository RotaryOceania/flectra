...
class TestContractPortal(flectra.tests.HttpCase):
    def test_tour(self):
        ...
        self.browser_js(
            "/",
            "flectra.__DEBUG__.services['web_tour.tour'].run('contract_portal_tour')",
            "flectra.__DEBUG__.services['web_tour.tour'].tours.contract_portal_tour.ready",
            login="portal",
        )
        # Contract access
