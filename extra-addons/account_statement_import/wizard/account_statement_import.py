# Copyright 2004-2020 Flectra S.A.
    ...
    def _parse_file(self, data_file):
        ...
        raise UserError(
            _(
                ...
                "Did you install the Flectra module to support this format?"
            )
        )
        ...
        if not currency:
            raise UserError(
                _(
                    ...
                    "but there is no such currency in Flectra."
                )
                % currency_code
            )
        return currency
        ...
        if not account_number:  # exemple : QIF
            ...
            if not journal:
                ...
                if bank_accounts:
                    raise UserError(
                        _(
                            "The bank account with number '%s' exists in Flectra "
